...
const ProfitWeekdayWidget = ({nonSummaryPositions, isLoading}) => {
    ...
    const lossMap = useMemo(() => Object.entries(lossPositions.reduce((acc, curr) => {
        const key = moment(curr.openDate).format('dddd');
    ...
    return <div className="widget">
        <div className="widget_header">Прибыль по неделям</div>
...
export default ProfitWeekdayWidget;